...
<div align="center">
  ...
  <img src="img/0.png" width="30%" max-width="100px" alt="Main Header Image" />

  <h3>"내 멘탈은 몇 % 남아있을까?"</h3>
  <p>나도 모르는 내 멘탈 상태, 지금 바로 확인해보세요!</p>

  <a href="https://ojoj717.github.io/Mental-Percentage-Test/" target="_blank">
    <img src="https://img.shields.io/badge/-테스트_바로가기-6eac70?style=for-the-badge&labelColor=333333&logo=rocket&logoColor=white" height="45">
  </a>
...
**현대인의 고질병, '번아웃(Burnout)'!** <br>
우리는 앞만 보고 달리느라 정작 자신의 마음이 얼마나 타들어 가고 있는지 놓치곤 합니다. <br>
    ...
    <tr>
      <td style="background-color: #faffe9; padding: 20px;">
        ...
        <table>
          ...
          <tr align="center">
            <td><img src="README_img/main.png" width="180"></td>
            <td><img src="README_img/question.png" width="180"></td>
            <td><img src="README_img/result.png" width="180"></td>
            <td><img src="README_img/all_result.png" width="180"></td>
          </tr>
          <tr align="center">
...
├── 📄 <b>index.html</b>           <font color="#777"># 메인 진입 페이지</font>
├── 📂 <b>css/</b>
│   └── 🎨 style.css        <font color="#777"># 전체 UI/UX 디자인</font>
├── 📂 <b>js/</b>
│   ├── 📊 data.js          <font color="#777"># 질문, 선지 및 결과 데이터</font>
│   └── 🧠 main.js          <font color="#777"># 멘탈 계산 알고리즘</font>
└── 📂 <b>img/</b>                 <font color="#777"># 비주얼 리소스 모음</font>
</pre>
